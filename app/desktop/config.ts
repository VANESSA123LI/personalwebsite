...
export const CONVERSATIONS: Conversation[] = [
  ...
  },
  {
    ...
    time: "Yesterday",
    messages: [
      { from: "them", text: "did you see the seed round that got done at 40 post??" },
      { from: "me", text: "SF is undefeated" },
      { from: "them", text: "two founders, no product, one waitlist" },
      { from: "me", text: "the waitlist WAS the product" },
      { from: "them", text: "ok fair. anyway — sending you a deck, defense tech + finance infra angle" },
      { from: "me", text: "on it. flagging it for the partners tomorrow" },
    ],
  },
  {
    id: "chat-3",
    ...
    time: "Tuesday",
    messages: [
      { from: "them", text: "moving to SF next month. hayes valley or mission?" },
      { from: "me", text: "hayes if you want cafés, mission if you want burritos" },
      { from: "them", text: "why not both" },
      { from: "me", text: "spoken like a true founder. welcome home 🌉" },
      { from: "them", text: "also — my robotics demo is friday. you around?" },
